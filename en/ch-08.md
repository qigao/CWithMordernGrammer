...
It extends one Typed Graph from synchronous data transformation into execution that is suspendable, resumable, flow-controlled, and explicit about terminal semantics.
