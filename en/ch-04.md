...
>
> Graph lets the system see, before execution:
>
> ~~~text
> operator
> input/output type
...
> ~~~
>
> so construction can validate, normalize, rewrite, and compile.
...
Its only limitation is that after execution the structure:

~~~text
Filter -> Map -> Reduce
~~~

no longer exists as a program object.
...
construction fails immediately with TYPE_MISMATCH.
...
~~~text
operator cannot lower to selected backend
    ↓
UNSUPPORTED
~~~
