...
Callable
    = how one admitted executable shape is represented
~~~
...
One native semantic source can then support several consumers:
...
Those are generator/compiler checks:
