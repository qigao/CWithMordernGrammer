...
~~~text
machine_step concurrent count <= 1
~~~

这是 Actor 真正提供的 mutable-state isolation。
...
因为旧 ref 没有 authority 调用这个 actor。
