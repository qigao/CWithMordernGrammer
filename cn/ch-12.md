...
~~~text
qualified/native identity
return type semantic identity
parameter count
parameter semantic types
direction
ownership/nullability where ABI-significant
effects/properties when contract-significant
~~~
...
跨 DSO 的 struct 不应该直接假定：

~~~text
sizeof(host struct)
==
sizeof(plugin struct)
~~~
