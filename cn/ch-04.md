...
> ~~~
>
> 因此可以 build-time validate、normalize、rewrite 和 compile。
...
~~~text
edge source output != destination input
    ↓
TYPE_MISMATCH
~~~
...
不偷偷 realloc，如果 bounded graph 是 contract。
