...
no rewrite
no alternate execution backend
~~~
...
~~~text
not stored across complex lifetime
not composed
not reflected
not optimized
~~~
...
~~~text
same logical contract repeated across backends
~~~
...
cross-DSO capability
safe unload
~~~

才选择 PLUGIN projection。
